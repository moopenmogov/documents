(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .nfb-btn:not(.nfb-pulse):hover { background: #8b5cf6 !important; color: white !important; }
      ...
      /* Pulsing animation - blue to purple transition matching OpenGov branding */
      @keyframes nfb-pulse {
        0% {
      ...
      #newFeaturesBtn.nfb-pulse::before {
        animation: nfb-pulse 2s ease-in-out;
      }
