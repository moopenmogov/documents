...
if (-not $strings) {
  ...
  $strings = [pscustomobject]@{
    title      = 'The Future of Contracting...Cometh!'
    message    = "Hi there, thanks for offering to help! The next steps might be a little daunting if this is the first time you've used this type of software. But I promise, it's not that bad.`n`nClear off your desktop, or create a new one, and make sure word is closed. Once you embark on this journey several things will happen:`n`n1 - it will start raining tacos`n2 - tons of windows will pop up`n3 - your web browser will open up with a nifty website`n4 - word should show up with a similarly nifty thing on the side`n`nAlternatively, this could crash and nothing will happen.`n`nLet's live on the edge!`n`n---`n"
